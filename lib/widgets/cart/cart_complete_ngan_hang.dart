...
class CartCompleteNganHang extends StatefulWidget {
  final CartResultModel result;
  CartCompleteNganHang({Key key, @required this.result}) : super(key: key);
  @override
  CartCompleteNganHangState createState() => CartCompleteNganHangState();
}

class CartCompleteNganHangState extends State<CartCompleteNganHang> {
  String currencyF;
  @override
  void initState() {
    super.initState();
      ...
      body: SafeArea(
        ...
        child: Column(
          children: <Widget>[
            ...
            ItemThanhToanNganHang(result: widget.result, currency: currencyF),
          ],
        ),
      )),
