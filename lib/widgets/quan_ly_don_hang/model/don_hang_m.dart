...
//   DonHangModel({this.giaoDichId, this.ma_giao_dich, this.tongTtien, this.tinhTrang, this.timeCreate, this.thoiGianGiaoDich, this.thongTinGiaoDich, this.tieuDeDonHang});
...
//   GiaoHangModel({this.email, this.hoTen, this.diaChi, this.ghiChu, this.soDienThoai});
...
//   @JsonKey(name: 'ngan_hang', defaultValue: '')
...
//   ThongTinThanhToanModel({this.email, this.hoTen, this.diaChi, this.soDienThoai, this.nguoiGioiThieu});
...
//   SanPhamModel({this.uid, this.moTa, this.donGia, this.soLuong, this.timeCreate, this.maSanPham, this.sanPhamId, this.tenSanSham, this.hinhDaiDien, this.tieuDeDonHang});
